...
- [x] T6 — Validar contra todos los criterios de aceptación de la spec 002 (depende de: T5)
- [x] T7 — Registrar resultado y decisiones en `memoria/DECISIONES.md` (depende de: T6)
